...
function Profile(props) {
  ...
  const followHandler = async () => {
    try {
      if (followed) {
        await axiosJWT.put(
          `https://api-nodejs-y7qorp3gha-ey.a.run.app/api/user/${username}/unfollow`,
          {},
          {
        ...
        await axiosJWT.put(
          `https://api-nodejs-y7qorp3gha-ey.a.run.app/api/user/${username}/follow`,
          {},
          {
            headers: { Authorization: "Bearer " + currentUser.accessToken },
          }
  ...
  useEffect(() => {
    const fetchUser = async () => {
      const res = await axios.get(
        "https://api-nodejs-y7qorp3gha-ey.a.run.app/api/user/u/" + username
      );
      setCurrentUser(res.data.user);
      const pst = await axios.get(
        "https://api-nodejs-y7qorp3gha-ey.a.run.app/api/article/u/" + username
      );
      setPosts(
        pst.data.sort((p1, p2) => {
              ...
              <div className="profilePost">
                <img
                  src={
                    p.imgurl
                      ? p.imgurl
                      : process.env.PUBLIC_URL + "/images/defaultpost.jpg"
                  }
                  alt=""
