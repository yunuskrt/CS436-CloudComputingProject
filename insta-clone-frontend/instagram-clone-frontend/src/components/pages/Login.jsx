...
function Login() {
  ...
  const HandlerLoginForm = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("https://api-nodejs-y7qorp3gha-ey.a.run.app/api/user/login", {
      ...
      <div className="loginWrapper">
        <div className="loginLeft">
          <div className="frontImgWrapper">
            <img
              src={process.env.PUBLIC_URL +"/images/loginpage1.png"}
              className={show1 === 1 ? "frontImg show" : "frontImg hide"}
              alt=""
            />
            <img
              src={process.env.PUBLIC_URL + "/images/loginpage2.png"}
              className={show1 === 2 ? "frontImg show" : "frontImg hide"}
              alt=""
            />
            <img
              src={process.env.PUBLIC_URL + "/images/loginpage3.png"}
              className={show1 === 3 ? "frontImg show" : "frontImg hide"}
              alt=""
            />
            <img
              src={process.env.PUBLIC_URL +"/images/loginpage4.png"}
