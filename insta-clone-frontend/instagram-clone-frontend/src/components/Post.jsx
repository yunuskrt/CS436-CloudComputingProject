...
function Post(props) {
  ...
  const deleteHandler = async () => {
    try {
      await axiosJWT.delete(`https://api-nodejs-y7qorp3gha-ey.a.run.app/api/article/${post._id}`, {
  ...
  const likeHandler = async () => {
    try {
      await axiosJWT.get(`https://api-nodejs-y7qorp3gha-ey.a.run.app/api/article/${post._id}/like`, {
        headers: { Authorization: "Bearer " + user.accessToken },
      });
    } catch (error) {}
